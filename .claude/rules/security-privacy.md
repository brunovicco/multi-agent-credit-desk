...
- Do not log personal data, secrets, authentication headers, prompts, model responses, or complete payloads. The only sanctioned exception is Langfuse tracing explicitly opted into per `docs/LLM_OBSERVABILITY.md`'s approval checklist; it stays metadata-only otherwise.
